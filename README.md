# 🛡️ Projeto de Extensão: Criptografia Cidadã - Protegendo sua Casa Digital
...
*   🎬 **Assista ao vídeo:** [INSERIR LINK DO VÍDEO NO YOUTUBE/VIMEO]
*   ⏱️ **Duração:** 5 a 10 minutos *(Resolução Full HD 1080p, com legendas para acessibilidade)*.
...
*   🎧 **Ouça o episódio:** [INSERIR LINK DO PODCAST NO SPOTIFY/SOUNDCLOUD]
*   ⏱️ **Duração:** 10 a 15 minutos.
...
*   ✏️ **Faça o Quiz aqui:** [INSERIR LINK PARA O FORMULÁRIO DO QUIZ]
...
*(Insira a imagem do infográfico aqui, ex: `![Infográfico de Segurança](caminho-da-imagem.png)`)*

---

## 🔗 Para Saber Mais

Se você deseja se aprofundar ainda mais em como construir defesas e cadeados mais fortes para a sua rotina digital, separamos 3 links fundamentais de referências que guiaram este projeto:

| Referência | Descrição |
| :--- | :--- |
| 📄 **[Relatório do Custo das Violações de Dados 2025 (IBM Security)](INSERIR_LINK)** | Acesse a pesquisa global completa e independente que detalha os prejuízos dos megavazamentos, o impacto da inteligência artificial nos ataques e os vetores mais comuns, como o phishing. |
| 📄 **[Cartilha de Segurança para Internet - Fascículo Privacidade](INSERIR_LINK)** | Material recomendado para entender de forma didática os riscos da navegação web e soluções práticas recomendadas por órgãos oficiais para o cidadão. |
| 📄 **[28 Principais Casos de Vazamentos de Dados na História (Lara Martins Advogados)](INSERIR_LINK)** | Um artigo elucidativo para entender na prática como a falta de criptografia afetou grandes corporações e a privacidade de milhões de pessoas no Brasil e no mundo ao longo da história. |
